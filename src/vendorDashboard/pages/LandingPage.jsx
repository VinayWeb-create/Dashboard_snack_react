...
// Views where the right food panel is visible
...
const LandingPageInner = () => {
  ...
  const showLoginHandler = () => { resetViews(); setShowLogin(true); setActiveView('login'); };
  const showRegisterHandler = () => { resetViews(); setShowRegister(true); setActiveView('register'); };
  ...
  const showWelcomeHandler = () => { resetViews(); setShowWelcome(true); setActiveView('welcome'); };
            ...
            {showGuest && (
              <div style={{ animation: 'fadeUp 0.5s ease both' }}>
                <div className="welcome-hero">
                  ...
                  <p>Login or register to start managing your firm, products, and menu — all from one powerful dashboard.</p>
